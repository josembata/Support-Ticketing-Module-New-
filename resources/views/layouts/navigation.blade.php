...
<div class="relative">
    <button class="relative">
        ...
        @endif
        <div >
         <a href="{{ route('notifications.readAll') }}" class="text-sm text-blue-600 underline">Mark all as read</a>
</div>
    </button>

    @if($notifications->count() > 0)
        <div class="absolute right-0 mt-2 w-80 bg-white shadow-lg rounded-xl">
            @foreach($notifications as $notification)
                <div class="p-3 border-b hover:bg-blue-600">
